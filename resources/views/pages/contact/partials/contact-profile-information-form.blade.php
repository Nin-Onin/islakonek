<section>
    ...
    <form method="post" action="{{ route('contact.store') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input id="age" name="age" type="text" placeholder="Enter Age" class="mt-1 block w-full"
                required autofocus autocomplete="off" />
        </div>

        <div>
            <x-input-label for="sex" :value="__('Sex')" />
            <x-text-input id="sex" name="sex" type="text" placeholder="Enter Sex" class="mt-1 block w-full"
                required autofocus autocomplete="off" />
        </div>
